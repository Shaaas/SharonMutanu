...
export const metadata: Metadata = {
  metadataBase: new URL("https://mysabuilds.com"),
  ...
  keywords: ['web design Nairobi', 'web development Kenya', 'SACCO system Kenya', 'M-Pesa integration', 'digital platform Kenya', 'Next.js developer Nairobi', 'website designer Nairobi', 'app development Kenya', 'Supabase developer', 'delivery app Kenya', 'MYSA Builds'],
  openGraph: {
  ...
  twitter: { card: 'summary_large_image', title: 'MYSA Builds', images: ['/og-image.png'], creator: '@Sharon_Mutan' },
