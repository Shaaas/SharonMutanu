      ...
      <section className="page-section section-divider">
        <div className="two-col" style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '400px 1fr', gap: '5rem', alignItems: 'start' }}>
          ...
          <div className="reveal-right">
            ...
            <p style={{ color: '#888', fontSize: '.9rem', lineHeight: 1.9, marginBottom: '2.5rem' }}>When I am not building client projects, I am studying design systems, reading about what is working online, and reworking details most people would never notice. It is a bit obsessive. It works.</p>
